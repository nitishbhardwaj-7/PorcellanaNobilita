  ...
  try {
    ...
    const blog = await prisma.blog.update({
      ...
      data: {
        ...
        ...(subtitleAlign !== undefined && { subtitleAlign }),
        ...(showDateOnCard !== undefined && { showDateOnCard }),
        ...(showAuthorOnCard !== undefined && { showAuthorOnCard }),
        ...(slug !== undefined && { slug }),
        ...(excerpt !== undefined && { excerpt }),
        ...(author !== undefined && { author }),
        ...(authorColor !== undefined && { authorColor }),
        ...(authorFont !== undefined && { authorFont }),
        ...(authorSize !== undefined && { authorSize }),
        ...(authorAlign !== undefined && { authorAlign }),
        ...(dateColor !== undefined && { dateColor }),
        ...(dateFont !== undefined && { dateFont }),
        ...(dateSize !== undefined && { dateSize }),
        ...(dateAlign !== undefined && { dateAlign }),
