  ...
  try {
    ...
    const blog = await prisma.blog.create({
      data: {
        ...
        subtitleColor: subtitleColor || "grey",
        subtitleFont: subtitleFont || "default",
        subtitleSize: subtitleSize || "standard",
        subtitleAlign: subtitleAlign || "left",
        showDateOnCard: showDateOnCard ?? true,
        showAuthorOnCard: showAuthorOnCard ?? true,
        slug: finalSlug,
        excerpt: excerpt || null,
        author: author || "NOBILITA Editorial Team",
        authorColor: authorColor || "teal",
        authorFont: authorFont || "default",
        authorSize: authorSize || "standard",
        authorAlign: authorAlign || "left",
        dateColor: dateColor || "teal",
        dateFont: dateFont || "default",
        dateSize: dateSize || "standard",
        dateAlign: dateAlign || "left",
