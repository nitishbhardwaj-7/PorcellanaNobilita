    ...
    <div className="min-h-screen bg-white text-brand-dark flex flex-col justify-between overflow-x-hidden relative">
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-col items-center max-w-[720px] mx-auto space-y-6 md:space-y-8"
        >
      ...
      <section className="w-full bg-white text-brand-dark py-10 md:py-14 px-6">
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <p className={`${fontClass(post.subtitleFont, "font-ivymode")} font-light ${paragraphSizeClass(post.subtitleSize, "text-[clamp(19px,2.35vw,31px)]")} leading-[1.3] ${colorClass(post.subtitleColor, "text-[#1a1a1a]")} tracking-[0.01em] w-full text-center`}>
            {post.subtitle || "A collection where timeless Italian elegance meets advanced porcelain technology."}
          </p>
        </motion.div>
      </section>

      {/* Section 3: Main Hero Showcase Image */}
      <section className="w-full bg-white py-0 md:py-4 px-6">
        <motion.div
        ...
        >
          <div className="w-full overflow-hidden shadow-sm rounded-sm border border-gray-200/60 bg-gray-50">
            <img
              src={post.heroImage}
      ...
      <section className="w-full bg-white text-brand-dark py-14 md:py-20 px-6">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-stretch justify-center gap-8 md:gap-10">
            ...
            <div className="flex shrink-0 justify-center md:justify-start">
              <div className="w-full max-w-[260px] sm:max-w-[280px] md:w-[260px] lg:w-[280px] h-full flex overflow-hidden shadow-sm border border-gray-100/80 rounded-sm">
                <img
                  src={spec.slabImage}
            ...
            <div className="flex flex-col justify-between py-0 text-left flex-1 max-w-xl">
              {/* Top: Product Title */}
              <div>
                <h2 className={`${fontClass(spec.productNameFont, "font-ivymode")} ${headingSizeClass(spec.productNameSize, "text-xl sm:text-2xl lg:text-3xl")} font-light ${colorClass(spec.productNameColor, "text-[#1a1a1a]")} tracking-wider uppercase leading-tight mt-0`}>
                  {spec.productName}
                </h2>
              </div>

              {/* Middle: Specs Container with FeaturedProduct.tsx exact icons & refined typography */}
              <div className="space-y-4 md:space-y-6 py-4 md:py-3">
                {/* 1. DIMENSIONS */}
                <div className="grid grid-cols-[auto_1fr] gap-x-3.5 md:gap-x-5 items-start">
                  {/* Dimensions SVG Icon from FeaturedProduct.tsx */}
                  <div className="w-5 md:w-7 flex items-center justify-start text-[#545759] pt-0.5">
                    <svg viewBox="2 5 25 18" fill="none" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" className="w-5 md:w-7 h-auto">
                  ...
                  <div>
                    <h3 className="font-michroma text-xs md:text-sm font-semibold tracking-widest text-[#1a1a1a] uppercase">
                      DIMENSIONS
                    </h3>
                    <div className="font-michroma text-[11px] sm:text-[12px] md:text-[13px] font-light text-gray-800 tracking-[0.08em] leading-[1.6] space-y-0.5 mt-0.5">
                ...
                <div className="grid grid-cols-[auto_1fr] gap-x-3.5 md:gap-x-5 items-start">
                  ...
                  <div className="w-5 md:w-7 flex items-center justify-start text-[#545759] pt-0.5">
                    <svg viewBox="2 9 24.5 11" fill="none" stroke="currentColor" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" className="w-5 md:w-7 h-auto">
                ...
                <div className="grid grid-cols-[auto_1fr] gap-x-3.5 md:gap-x-5 items-start">
                  ...
                  <div className="w-5 md:w-7 flex items-center justify-start text-[#545759] pt-0.5">
                    <svg viewBox="2 10.8 24.5 7" fill="none" className="w-5 md:w-7 h-auto">
                      <defs>
      ...
      <section className="w-full bg-[#007190] text-white py-8 md:py-10 border-t border-b border-white/10 px-6">
        <div className="w-full max-w-[720px] mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 divide-y sm:divide-y-0 md:divide-x divide-white/25">
            {applications.map((app, idx) => (
              <Link
                key={idx}
                href="/explore-collection"
                className="flex flex-col items-center justify-center p-3 md:p-4 group hover:bg-white/5 transition-colors duration-300"
              >
                <div className="h-10 md:h-12 lg:h-14 flex items-center justify-center mb-2">
                  <img
                    src={app.icon}
                    alt={app.name}
                ...
                <span className="font-michroma text-[clamp(8px,0.75vw,10px)] text-white tracking-[0.12em] uppercase font-light text-center leading-tight">
                  {app.name}
                </span>
              </Link>
            ))}
      ...
      <section
        className="relative w-full bg-cover bg-center py-10 md:py-14 px-6 overflow-hidden"
        style={{ backgroundImage: "url('/images/Nobilita Newsletter/Links/Statuario Ultimo 1.jpg')" }}
      >
        <div className="absolute inset-0 bg-white/25 pointer-events-none" />

        <div className="relative z-10 w-full max-w-[720px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <Link
            href="/"
            className="font-michroma text-[clamp(12px,1.3vw,16px)] text-[#1a1a1a] tracking-[0.25em] font-light uppercase hover:opacity-75 transition-opacity"
          >
            NOBILITA.COM
          </Link>
          ...
          <button
            ...
            className="font-michroma text-[clamp(12px,1.3vw,16px)] text-[#1a1a1a] tracking-[0.25em] font-light uppercase hover:opacity-75 transition-opacity focus:outline-none cursor-pointer"
          >
            DOWNLOAD CATALOG
          </button>
        </div>
