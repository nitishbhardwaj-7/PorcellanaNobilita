    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-white font-serif">Add Service Page</h2>
            <p className="text-sm text-slate-400">Introduce a new premium architecture or finishing service.</p>
          </div>
        </div>
        <button
          type="submit"
