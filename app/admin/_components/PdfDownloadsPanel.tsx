...
/**
 * Manages the three CMS-editable PDFs visitors download from the site
 * (catalogue + English/Italian datasheets). Lives inside the Media Library
 * as its own tab rather than a separate page, since it's still "managing
 * files" from the user's point of view.
 */
export default function PdfDownloadsPanel() {
