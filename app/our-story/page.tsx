...
export default async function OurStoryPage() {
  ...
  try {
    ...
    cmsData = {
      ...
      storyHeroPara3: settings?.storyHeroPara3,
      storyHeroPara3Color: settings?.storyHeroPara3Color,
      storyHeroPara3Font: settings?.storyHeroPara3Font,
      storyHeroPara3Size: settings?.storyHeroPara3Size,
      ...
      storySec2Line2: settings?.storySec2Line2,
      storySec2Line2Color: settings?.storySec2Line2Color,
      storySec2Line2Font: settings?.storySec2Line2Font,
      storySec2Line2Size: settings?.storySec2Line2Size,
      ...
      storySec4Line3: settings?.storySec4Line3,
      storySec4Line3Color: settings?.storySec4Line3Color,
      storySec4Line3Font: settings?.storySec4Line3Font,
      storySec4Line3Size: settings?.storySec4Line3Size,
