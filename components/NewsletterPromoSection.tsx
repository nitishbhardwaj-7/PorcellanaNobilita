  ...
  return (
    <section className="relative w-full min-h-[60vh] overflow-hidden bg-brand-dark">
      <div className="absolute inset-0 w-full h-full bg-black overflow-hidden flex justify-center items-center">
        ...
        <div className="relative z-10 w-full max-w-6xl flex justify-center items-center px-6">
          <button onClick={(e) => {
            e.preventDefault();
            window.dispatchEvent(new CustomEvent("open-newsletter-form"));
          }}
            className="relative overflow-hidden border border-[#545759] text-[#545759] bg-transparent px-8 py-2.5 font-michroma text-[clamp(12px,1.5vw,20px)] tracking-[0.25em] transition-colors duration-500 uppercase group min-w-[280px] md:min-w-[420px] text-center focus:outline-none">
